...
//	DebugDrawStuff();
	...
	var currentRotation = Quaternion.Euler (45, 0, 0);
...
function LateUpdate () {
	...
	GameObject.Find("xpos").guiText.text = transform.position.x.ToString();
	GameObject.Find("zpos").guiText.text = transform.position.z.ToString();
}
